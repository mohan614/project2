...
public class Rectangle extends Applet
{
		   ...
		   switch(ch)
         	{
				...
				case 1:
						
						{
						  for( i=0;i<n;i++)
							{
							  System.out.println("\nenter BURST TIME for each process: p" +(i+1));
 ...
 { 
  ...
  g.drawString("p"+p[j-4],(55+(apw1[j-4]*2)),7);
  g.drawString(""+apw1[j-4],50+(apw1[j-4]*2),10);
  }
 g.drawString(""+apw1[n1],50+(apw1[n1]*2),10);
  }
}

/*
<applet code="rectangle" height=400 width=950>
</applet>
*/